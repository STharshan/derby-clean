...
export default function TestimonialsSection() {
  const testimonials = [
    {
      name: "BeaR-10",
      text: `Thankyou James to you and your team for the continued work throughout the pandemic and beyond keeping our frontline office a safe place to work.`,
      rating: 5,
    },
    {
      name: "LaiylaS",
      text: `5 star service. Would recommend`,
      rating: 5,
    },
    {
      name: "JamesS-2438",
      text: `Amanda from perfectly clean is an absolute gem, always on time and does such a lovely job of our house`,
      rating: 5,
    },
  ];
